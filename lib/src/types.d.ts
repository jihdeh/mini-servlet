...
export declare type ResponseValueType = string | number | Array<number | string> | Record<string, unknown> | Buffer;
...
export declare type Middleware = (req: RequestHandler, res: ResponseHandler) => void;
